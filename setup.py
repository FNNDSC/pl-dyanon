...
setup(
    name='dyanon',
    version=get_version('dyanon.py'),
    description='A ChRIS plugin to dynamically anonymize DICOMs in bulk',
    author='FNNDSC',
    author_email='dev@babyMRI.org',
    url='https://github.com/FNNDSC/pl-dy',
    py_modules=['dyanon','base_client','chrisClient','pfdcm','chris_pacs_service','pipeline','runnable'],
